<div>
    <div class="modal-header p-6">
        <h5 class="modal-title">{{ __('Nuovo Gruppo') }}</h5>
    ...
    <div class="modal-body px-6">
        <form id="aggiungi-gruppo-form" wire:submit="create">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" form="aggiungi-gruppo-form" class="btn btn-primary">{{ __('Salva') }}</button>
    </div>
</div>
